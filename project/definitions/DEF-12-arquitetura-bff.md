...
6. Há requisitos de comunicação assíncrona (message queues)?
    Ver [DEF-19-integracao-interfaces.md](DEF-19-integracao-interfaces.md) para detalhes de Message Broker

### Escalabilidade
> **Nota:** Detalhes de auto-scaling em [DEF-22-desempenho-fiabilidade.md](DEF-22-desempenho-fiabilidade.md)

7. Quais são os requisitos de escalabilidade do BFF?
    Suportar 400 utilizadores concorrentes (DEF-04-requisitos-nao-funcionais)
...
10. Como será tratada a autenticação entre frontend e BFF?
    Fluxo OAuth pré-definido (ver DEF-13-autenticacao-oauth.md). Frontend inicia autenticação, BFF valida via App ou OTP.
...
- [DEF-05-principios-arquitetura.md](DEF-05-principios-arquitetura.md) - Decisão de BFF
