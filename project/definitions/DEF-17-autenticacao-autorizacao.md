...
# DEF-17: Autenticação & Autorização

> **Secção relacionada:** [7 - Autenticação & Autorização](../sections/SEC-07-autenticacao-autorizacao.md)

## Contexto

Definir a estratégia de autenticação e autorização do HomeBanking Web. Nota: O fluxo básico OAuth já foi definido em DEF-12-arquitetura-bff.md. Este documento aprofunda os detalhes de sessão, MFA, e políticas de segurança.
...
- [DEF-12-arquitetura-bff.md](DEF-12-arquitetura-bff.md) - Fluxo OAuth básico
- [DEF-18-seguranca-conformidade.md](DEF-18-seguranca-conformidade.md) - PSD2
