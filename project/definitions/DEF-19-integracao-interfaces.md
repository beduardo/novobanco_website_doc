...
# DEF-19: Integração & Interfaces Externas
...
> **Nota:** Padrões de resiliência (retry, circuit breaker) consolidados em [DEF-15-padroes-resiliencia.md](DEF-15-padroes-resiliencia.md)
...
25. Quais integrações têm fallback definido?
    Autenticação (fallback OTP). Ver DEF-15-padroes-resiliencia.
...
- [DEF-12-arquitetura-bff.md](DEF-12-arquitetura-bff.md) - Arquitetura BFF
- [DEF-11-api-design.md](DEF-11-api-design.md) - Padrões de API
