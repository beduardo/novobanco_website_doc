...
# DEF-06: Casos de Uso Principais
...
> **Nota:** Requisitos de PWA/Offline estão definidos em [DEF-10-ux-guidelines.md](DEF-10-ux-guidelines.md)
> **Nota:** Detalhes de SCA estão definidos em [DEF-17-autenticacao-autorizacao.md](DEF-17-autenticacao-autorizacao.md)
...
- **Nota:** Detalhes de implementação em [DEF-17-autenticacao-autorizacao.md](DEF-17-autenticacao-autorizacao.md)

### PWA e Offline
- **Decisão:** Ver [DEF-10-ux-guidelines.md](DEF-10-ux-guidelines.md)
