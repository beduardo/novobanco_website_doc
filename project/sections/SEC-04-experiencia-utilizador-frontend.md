...
> - [DEF-08-stack-frontend.md](../definitions/DEF-08-stack-frontend.md) - Status: completed
> - [DEF-09-design-system.md](../definitions/DEF-09-design-system.md) - Status: completed
> - [DEF-10-ux-guidelines.md](../definitions/DEF-10-ux-guidelines.md) - Status: completed
>
...
- [x] [DEF-08-stack-frontend.md](../definitions/DEF-08-stack-frontend.md) - Status: completed
- [x] [DEF-09-design-system.md](../definitions/DEF-09-design-system.md) - Status: completed
- [x] [DEF-10-ux-guidelines.md](../definitions/DEF-10-ux-guidelines.md) - Status: completed
...
|------|-----------|-------------|
| ~~PWA/Offline requirements~~ | ~~DEF-10-ux-guidelines~~ | ~~Arquitetura~~ | **Decidido: Não será PWA** |
| Comunicação de segurança ao utilizador | DEF-10-ux-guidelines | UX + Segurança |
| ~~WCAG level~~ | ~~DEF-09-design-system~~ | ~~UX~~ | **Decidido: WCAG 2.1 AA** |
| Bundle size limits | DEF-08-stack-frontend | Performance |
| Pontos de dor app mobile | DEF-10-ux-guidelines | UX |
| Comportamento em conectividade intermitente | DEF-10-ux-guidelines | UX |
