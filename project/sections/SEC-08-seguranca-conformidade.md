...
> - [DEF-18-seguranca-conformidade.md](../definitions/DEF-18-seguranca-conformidade.md) - Status: completed
>
...
- [x] [DEF-18-seguranca-conformidade.md](../definitions/DEF-18-seguranca-conformidade.md) - Status: completed
...
|------|-----------|-------------|--------|
| Threat modeling | DEF-18-seguranca-conformidade | Segurança | Pendente |
| Metodologia threat modeling | DEF-18-seguranca-conformidade | Segurança | Pendente |
| max-age HSTS | DEF-18-seguranca-conformidade | Segurança | Pendente |
| WAF (definição) | DEF-18-seguranca-conformidade | Infraestrutura | Pendente |
| Controlos OWASP Top 10 | DEF-18-seguranca-conformidade | Segurança | Pendente |
| SAST/DAST no pipeline | DEF-18-seguranca-conformidade | DevOps | Pendente |
| Frequência de scans | DEF-18-seguranca-conformidade | Segurança | Pendente |
| Dynamic Linking (aprofundar) | DEF-18-seguranca-conformidade | Arquitetura | Pendente |
...
| Resposta a incidentes | DEF-18-seguranca-conformidade | Segurança | Pendente |
| Gestão de vulnerabilidades | DEF-18-seguranca-conformidade | Segurança | Pendente |
| Segregação de ambientes | DEF-18-seguranca-conformidade | Infraestrutura | Pendente |
