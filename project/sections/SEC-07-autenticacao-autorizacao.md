...
> - [DEF-17-autenticacao-autorizacao.md](../definitions/DEF-17-autenticacao-autorizacao.md) - Status: completed
> - [DEF-12-arquitetura-bff.md](../definitions/DEF-12-arquitetura-bff.md) - Status: completed
>
...
- [x] [DEF-17-autenticacao-autorizacao.md](../definitions/DEF-17-autenticacao-autorizacao.md) - Status: completed
- [x] [DEF-12-arquitetura-bff.md](../definitions/DEF-12-arquitetura-bff.md) - Status: completed
...
| Logout automático outras sessões | DEF-17-autenticacao-autorizacao | Segurança | Pendente |
| Estratégia CAPTCHA | DEF-17-autenticacao-autorizacao | Segurança | Pendente |
| Rate limiting login | DEF-17-autenticacao-autorizacao | Arquitetura | Pendente |
| Deteção de bots | DEF-17-autenticacao-autorizacao | Segurança | Pendente |
| Logout de todos dispositivos | DEF-17-autenticacao-autorizacao | Segurança | Pendente |
| Revogação de tokens | DEF-17-autenticacao-autorizacao | Segurança | Pendente |
